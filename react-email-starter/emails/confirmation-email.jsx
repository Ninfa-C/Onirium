...
export const ConfirmationEmail = ({ name, confirmationLink }) => (
  <Html lang="it">
    <Head />
    <Tailwind
      config={{
    ...
    >
      <Container className="bg-secondBg text-center text-white h-[90vh]">
        <div className="flex text-gold items-center justify-center">
          <svg
            version="1.0"
          ...
          >
            ...
            >
              <path
                d="M5125 9064 c-16 -2 -79 -9 -140 -15 -384 -38 -831 -189 -1166 -392
...
-798 470 -1280 540 -133 19 -504 35 -580 24z"
              />
              <path
                d="M2564 8531 c-10 -13 -61 -74 -113 -134 l-94 -111 12 -45 c7 -25 24
-83 38 -129 30 -97 20 -101 140 46 l85 104 -11 77 c-6 42 -17 108 -24 146
l-13 70 -20 -24z"
              />
              <path
                d="M4550 8319 c-487 -54 -1003 -239 -1430 -513 -735 -470 -1234 -1166
...
-501 930 -257 225 -590 375 -953 430 -127 19 -433 27 -550 14z"
              />
              <path
                d="M1770 7718 c-47 -56 -109 -131 -138 -166 l-53 -63 74 -147 c41 -80
79 -147 83 -149 10 -2 259 340 256 351 -1 3 -32 67 -70 141 l-67 135 -85 -102z"
              />
              <path
                d="M4460 7143 c-14 -2 -75 -17 -137 -33 -368 -97 -790 -367 -1085 -694
...
26 56 32 -4 22z"
              />
              <path
                d="M8295 7050 c80 -236 116 -648 85 -985 -31 -339 -131 -703 -276 -1000
...
-26 51 -50 95 -54 98 -5 2 3 -27 16 -66z"
              />
              <path
                d="M5084 7017 c-19 -17 -29 -37 -33 -67 -7 -49 51 -9 -556 -387 -198
...
-22z"
              />
              <path
                d="M8464 3800 c-21 -30 -81 -111 -133 -180 -51 -69 -94 -129 -95 -135
-2 -18 79 -355 85 -355 12 0 249 368 249 386 0 16 -54 294 -64 329 -1 5 -20
-15 -42 -45z"
              />
            </g>
          </svg>
          <p className="text-5xl m-0">nirium</p>
        </div>
        <Heading className="text-gold ">Benvenut*, {name}</Heading>
        <Text>
        Per varcare la soglia del mondo di Onirium, conferma la tua iscrizione cliccando qui sotto:
        </Text>
...
ConfirmationEmail.PreviewProps = {
  name: "Mario Rossi",
  confirmationLink: "https://example.com/conferma?token=abc123",
};
